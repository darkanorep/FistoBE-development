...
class CreateConfidentialJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('confidential_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('confidential_journals');
    }
}
