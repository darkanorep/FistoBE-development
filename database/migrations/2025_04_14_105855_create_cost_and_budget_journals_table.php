...
class CreateCostAndBudgetJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cost_and_budget_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('cost_and_budget_journals');
    }
}
