...
class CreateApSpecialist22JournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ap_specialist22_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ap_specialist22_journals');
    }
}
