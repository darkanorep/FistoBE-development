...
class CreateConfidentialYearEndJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('confidential_year_end_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('confidential_year_end_journals');
    }
}
