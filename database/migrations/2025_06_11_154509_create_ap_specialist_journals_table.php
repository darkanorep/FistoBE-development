...
class CreateApSpecialistJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ap_specialist_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('ap_specialist_journals');
    }
}
