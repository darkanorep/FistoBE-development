...
class CreateAccountReceivableJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('account_receivable_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('account_receivable_journals');
    }
}
