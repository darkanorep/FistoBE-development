...
class CreateFixedAssetJournalsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('fixed_asset_journals', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('fixed_asset_journals');
    }
}
