...
use App\Models\Treasury22Journal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class Treasury22JournalController extends Controller
{
    private $journalService;

    public function __construct(Treasury22Journal $treasury22Journal)
    {
        $this->journalService = (new JournalServices($treasury22Journal));
    }
