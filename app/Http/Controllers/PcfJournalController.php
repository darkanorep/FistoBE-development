...
use App\Models\PcfJournal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class PcfJournalController extends Controller
{
    private $journalService;

    public function __construct(PcfJournal $pcfJournal)
    {
        $this->journalService = (new JournalServices($pcfJournal));
    }
