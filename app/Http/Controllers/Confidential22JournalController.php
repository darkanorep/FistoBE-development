...
use App\Models\Confidential22Journal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class Confidential22JournalController extends Controller
{
    private $journalService;

    public function __construct(Confidential22Journal $confidential22Journal)
    {
        $this->journalService = (new JournalServices($confidential22Journal));
    }
