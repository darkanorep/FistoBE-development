...
use App\Models\AccrualReversalJournals;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class AccrualReversalJournalsController extends Controller
{
    private $journalService;
    public function __construct(AccrualReversalJournals $accrualReversalJournals)
    {
        $this->journalService = (new JournalServices($accrualReversalJournals));
    }
