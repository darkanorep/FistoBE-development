...
use App\Models\YearEndJournal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class YearEndJournalController extends Controller
{
    private $journalService;

    public function __construct(YearEndJournal $yearEndJournal)
    {
        $this->journalService = (new JournalServices($yearEndJournal));
    }
