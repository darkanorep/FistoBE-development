...
use App\Models\Confidential30Journal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class Confidential30JournalController extends Controller
{
    private $journalService;

    public function __construct(Confidential30Journal $confidential30Journal)
    {
        $this->journalService = (new JournalServices($confidential30Journal));
    }
