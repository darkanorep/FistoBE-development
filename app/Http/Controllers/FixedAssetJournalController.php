...
class FixedAssetJournalController extends Controller
{
    /**
     * @var JournalServices
     */
    ...
    public function __construct(FixedAssetJournal $fixedAssetJournal)
    {
        $this->journalService = (new JournalServices($fixedAssetJournal));
    }
