...
use App\Models\CostAndBudget22Journal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class CostAndBudget22JournalController extends Controller
{
    /**
     * @var JournalServices
     */
    ...
    public function __construct(CostAndBudget22Journal $costAndBudget22Journal) {
        $this->journalService = (new JournalServices($costAndBudget22Journal));
    }
