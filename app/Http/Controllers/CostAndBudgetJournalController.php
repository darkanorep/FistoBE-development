...
use App\Models\CostAndBudgetJournal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class CostAndBudgetJournalController extends Controller
{
    /**
     * @var JournalServices
     */
    ...
    public function __construct(CostAndBudgetJournal $costAndBudgetJournal)
    {
        $this->journalService = (new JournalServices($costAndBudgetJournal));
    }
