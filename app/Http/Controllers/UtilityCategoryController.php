...
use App\Http\Requests\UtilityCategoryRequest;
...
//        }
    ...
    {
        $utility_category = UtilityCategory::create([
            'category' => $request->category
        ]);

        return $this->resultResponse('save','Utility Category', $utility_category);
...
//      }
    ...
    public function update(UtilityCategoryRequest $request,$id)
    {

        $utility_category = UtilityCategory::where('id', $id)->first();
