...
use App\Models\FoJournal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class FoJournalController extends Controller
{
    private $journalService;

    public function __construct(FoJournal $foJournal)
    {
        $this->journalService = (new JournalServices($foJournal));
    }
