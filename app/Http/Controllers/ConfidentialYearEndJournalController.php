...
use App\Models\ConfidentialYearEndJournal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class ConfidentialYearEndJournalController extends Controller
{
    private $journalService;

    public function __construct(ConfidentialYearEndJournal $confidentialYearEndJournal)
    {
        $this->journalService = (new JournalServices($confidentialYearEndJournal));
    }
