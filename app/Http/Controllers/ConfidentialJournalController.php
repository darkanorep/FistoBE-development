...
use App\Models\ConfidentialJournal;
use App\Services\JournalServices;
use Illuminate\Http\Request;

class ConfidentialJournalController extends Controller
{
    private $journalService;

    public function __construct(ConfidentialJournal $confidentialJournal)
    {
        $this->journalService = (new JournalServices($confidentialJournal));
    }
